...
function Home() {
  ...
  const filteredNowPlaying = useMemo(() => filterByGenre(nowPlaying), [nowPlaying, selectedGenre]);
  const filteredTopRated = useMemo(() => filterByGenre(topRated), [topRated, selectedGenre]);
  const filteredUpcoming = useMemo(() => filterByGenre(upcoming), [upcoming, selectedGenre]);
