...
import { Container, Box, Typography, Grid2, Card, CardContent, Button } from '@mui/material';
  ...
  return (
    ...
    >
      ...
      <Grid2 container spacing={2} sx={{ width: '100%' }}>
        <Grid2 size="grow">
          <Card onClick={handleNavigateReviews} sx={{ cursor: 'pointer', textAlign: 'center' }}>
            <CardContent>
        ...
        <Grid2 size="grow">
          <Card onClick={handleNavigateFavorites} sx={{ cursor: 'pointer', textAlign: 'center' }}>
            <CardContent>
